    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Update article: <span class="font-semibold text-purple-600">{{ Str::limit($article->title, 30) }}</span></p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border-2 border-gray-100">
                ...
                <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-8 py-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-white">Article Details</h3>
                            <p class="text-purple-100 text-sm">Update article content and media</p>
                        </div>
                    </div>
                </div>

                <!-- Form Content -->
                <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="content" 
                                  ...
                                  class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300">{{ $article->content }}</textarea>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        @if ($article->image)
                            <div class="mb-4 relative group">
                                <div class="relative w-full max-w-xs rounded-2xl overflow-hidden shadow-lg ring-4 ring-gray-200 group-hover:ring-purple-400 transition-all duration-300">
