    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Create a new medical equipment product</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-gradient-to-r from-green-600 to-green-700 px-8 py-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-green-100 text-sm">Fill in all required fields</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300"></textarea>
                    </div>
